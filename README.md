...
| `/evilsnooze/` | `evilsnooze/` — EvilSnooze (iPhone app): about, `support`, `privacy`. The App Store listing and the app link to `support` and `privacy`: never move or rename them without updating the app. The privacy page mirrors `docs/privacy-policy.md` in the evilsnooze repo |
